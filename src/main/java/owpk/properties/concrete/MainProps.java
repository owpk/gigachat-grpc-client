...
public class MainProps extends PropertiesProvider {
    ...
    public static final PropertyDef DEF_CHATS_HISTORY_HOME = new PropertyDef("chat_history_home", DEF_GIGACHAT_CLI_HOME.value() + "/chats/");
    public static final PropertyDef DEF_CURRENT_CHAT_NAME = new PropertyDef("chat_current_chat", "");

    public static final PropertyDef DEF_ROLES_YML = new PropertyDef("roles_yml", DEF_GIGACHAT_CLI_HOME.value() + "/roles.yml");
